...
int main()
{
    ...
    /* Move to J0 */
    hr = bCap_RobotMove(iSockFD, lhRobot, 1L, "J(-90,45,45,0,-90,0)", "Speed=25");
    sleep(2);
    hr = bCap_RobotMove(iSockFD, lhRobot, 1L, "J(-90,45,45,0,-80,0)", "Speed=10");
    sleep(2);
    hr = bCap_RobotMove(iSockFD, lhRobot, 1L, "J(-90,45,45,0,-73,0)", "Speed=5");
    // sleep(2);
    // hr = bCap_RobotMove(iSockFD, lhRobot, 1L, "J(-90,45,45,0,-75.5,0)", "Speed=25");
    // sleep(2);
    // hr = bCap_RobotMove(iSockFD, lhRobot, 1L, "J(-90,45,45,0,-75,0)", "Speed=25");
    // sleep(2);
    // hr = bCap_RobotMove(iSockFD, lhRobot, 1L, "J(-90,45,45,0,-74.5,0)", "Speed=50");
    // sleep(2);
    // hr = bCap_RobotMove(iSockFD, lhRobot, 1L, "J(-90,45,45,0,-74,0)", "Speed=50");
    /* Motor off */

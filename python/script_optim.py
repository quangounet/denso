...
trajopt = denso.MakeTraj(xopt,qstart,qend,ndof,nwaypoints,nsamples,vmax,amax)
close('all')
...
nextracols = 3
#denso.CreateProgram(xopt,trajref,nwaypoints,"../data/constraintparabolicsmoothingopt.pcs",nextracols)
